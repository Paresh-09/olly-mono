...
def move_blog_files(blocks_path, base_path, summary):
    """Move blog files from blocks to target structure"""
    ...
    for dir_name in block_dirs:
        ...
        target_dir = os.path.join(base_path, 'app/blog/_posts', target_dir_name)
...
def move_images(blocks_path, base_path, summary):
    """Move images from blocks to blog-posts images directory"""
    images_dir = os.path.join(base_path, 'public/images/blog-posts')
...
def main():
    blocks_path = 'blocks'
    base_path = '.'  # Changed to current directory since paths are now relative
    ...
    # Move files
    move_blog_files(blocks_path, base_path, summary)
    move_images(blocks_path, base_path, summary)
