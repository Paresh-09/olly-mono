...
export const metadata: Metadata = {
  title: 'Compare Olly.social with Alternatives | Feature Comparison',
  description: 'See how Olly.social compares to other social platforms. Compare features, pricing, and capabilities with leading alternatives.',
  openGraph: {
    title: 'Compare Olly.social with Alternatives',
    description: 'Detailed comparison of Olly.social features with leading social platforms',
    type: 'website',
    images: [
      {
        url: '/og-compare.jpg',
  ...
  alternates: {
    canonical: 'https://olly.social/compare'
  }
}
    ...
    <div className="container space-y-12">
      <div className="relative w-full h-64 mb-12 rounded-xl overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-background/90 to-background/50 flex items-center">
          <div className="p-8">
            <h1 className="text-4xl font-bold tracking-tight mb-4">Compare Olly.social</h1>
