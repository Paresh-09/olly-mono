...
import { Instagram, Youtube, ChevronRight, Linkedin } from 'lucide-react';
import { tools } from '@/data/use-cases/tool-data';
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-lg leading-8 text-gray-600">
            Goal is to help you succeed with Olly Social!
          </p>
        </div>
