...
const models = [
  { name: "LLaMA 3.1 8B", inputPrice: 0.05, outputPrice: 0.08 },
  { name: "GPT-OSS 20B", inputPrice: 0.1, outputPrice: 0.5 },
  { name: "GPT-OSS 120B", inputPrice: 0.15, outputPrice: 0.75 },
  { name: "Qwen3 32B", inputPrice: 0.3, outputPrice: 0.79 },
  { name: "LLaMA 3.1 70B", inputPrice: 0.59, outputPrice: 0.79 },
  { name: "DeepSeek R1 Distill Llama 70B", inputPrice: 0.75, outputPrice: 0.99 },
];

const commentLengthOptions = [150, 250, 500];

const GroqCostCalculator: React.FC = () => {
  const [selectedModel, setSelectedModel] = useState(models.find((model) => model.name === "LLaMA 3.1 8B") || models[0]);
...
export default GroqCostCalculator;