  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-gray-600 mb-4">
        We prefer to connect on Discord, but you can also use this form to reach
        out. For quick answers, try our &quot;Get Answers Now&quot; button - we
        use data and ChatGPT to answer up to 90% of common questions
        immediately!
      </p>
