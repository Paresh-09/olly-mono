...
import FAQDataMainContact from "../../_components/data/faq-data-contact";
  ...
  return (
    ...
    >
      ...
      <dl className="mt-10 space-y-8 divide-y divide-gray-900/10">
        {FAQDataMainContact.slice(
          0,
          showAll ? FAQDataMainContact.length : initiallyShown
        ).map((faq, index) => (
          <div
            key={faq.question}
      ...
      {FAQDataMainContact.length > initiallyShown && (
        <Button
