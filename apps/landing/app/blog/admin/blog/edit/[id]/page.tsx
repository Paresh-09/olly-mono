...
import { AlertCircle, Calendar, Globe, Image, Tag, Save, X, ArrowLeft, Loader2 } from "lucide-react";
    ...
    const fetchPost = async () => {
      try {
        ...
        const initialFormData: BlogPostFormData = {
          slug: mainPost.slug,
          date: mainPost.date ? new Date(mainPost.date).toISOString().split("T")[0] : new Date().toISOString().split("T")[0],
        ...
        initialFormData.languages[mainPost.language] = {
          id: mainPost.id,
        ...
        relatedPosts.forEach((relatedPost: any) => {
          if (relatedPost.language && initialFormData.languages[relatedPost.language]) {
    ...
    try {
      ...
      const postsToDelete = relatedPosts
        .filter(post => {
          ...
          return langCode && !formData.languages[langCode].isEnabled;
        })
        .map(post => post.id);
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader className="bg-gradient-to-r from-slate-50 to-slate-100 rounded-t-lg">
            <div className="flex justify-between items-center">
              <CardTitle className="text-3xl font-bold text-slate-800">Edit Blog Post</CardTitle>
              <Button
                variant="outline"
