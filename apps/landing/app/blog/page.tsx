...
function Posts() {
  ...
  const languages = [
    "all",
    ...Array.from(new Set(postData.map((post) => post.language)))
  ...
  const categories = [
    "all",
    ...Array.from(new Set(postData.flatMap((post) => post.categories)))
      .filter((cat) => cat !== "all")
      .sort(),
  ];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-8">
            ...
            <a href="https://chromewebstore.google.com/detail/olly-ai-agent-for-social/ofjpapfmglfjdhmadpegoeifocomaeje">
            <Button
              variant="default"
