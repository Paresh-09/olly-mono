export interface Competitor {
  ...
  "brand2social": {
    "name": "Brand2Social",
    "shortDescription": "Multi-platform social media scheduling and management tool",
    "category": "Social Media Management",
    "comparisonImage": "/images/comparisons/brand2social.png",
    "features": [
      {
        "category": "AI Capabilities",
        "features": [
          ...
          {
            "name": "Content Generation",
            "olly": "Advanced AI-powered content with customizable personalities",
            "competitor": "Basic AI content generation",
            "description": "Quality and capabilities of AI-generated content"
          }
        ]
      },
      {
        ...
        "features": [
          {
            "name": "Supported Platforms",
            "olly": ["LinkedIn", "Twitter/X", "Facebook", "Instagram", "Reddit", "Product Hunt", "YouTube", "Quora", "Medium", "TikTok", "Threads", "HackerNews"],
            "competitor": ["Facebook", "Instagram", "LinkedIn Page", "LinkedIn Profile", "Twitter/X", "Pinterest", "Google My Business", "TikTok", "YouTube"],
            "description": "Social media platforms supported"
          },
          {
            "name": "Platform Integration",
            "olly": "Direct browser extension integration",
            "competitor": "Web dashboard",
            "description": "Method of platform integration"
          }
        ]
      },
      {
        ...
        "features": [
          {
            "name": "Content Creation",
            "olly": ["AI-powered content", "Custom personalities", "Platform-specific optimization"],
            "competitor": ["Post scheduling", "Content calendar", "Post preview"],
          ...
          },
          {
            ...
            "olly": true,
            "competitor": true,
            "description": "Ability to schedule posts in advance"
          },
          {
            "name": "Content Analysis",
            "olly": ["Virality prediction", "Engagement metrics", "Performance analytics"],
            "competitor": ["Basic analytics", "Engagement reports"],
            "description": "Content performance measurement"
          }
        ]
      },
      {
        ...
        "features": [
          ...
          {
            "name": "Social Inbox",
            "olly": "Cross-platform engagement management",
            "competitor": "Centralized message management",
            "description": "Social media interaction management"
          },
          {
            "name": "White-label Solution",
            "olly": false,
            "competitor": "Custom domain (CNAME) and branding",
            "description": "Agency-focused white-label capabilities"
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "olly": true,
            "competitor": true,
            "description": "Support for managing multiple brands"
          },
          {
            "name": "Team Collaboration",
            "olly": true,
            "competitor": true,
            "description": "Multiple user collaboration tools"
          },
          {
            "name": "Approval Workflow",
            "olly": false,
            "competitor": true,
            "description": "Content approval workflow for teams"
          }
        ]
      },
      {
        ...
        "features": [
          ...
          },
          {
            "name": "API Key Security",
            "olly": true,
            "competitor": "Standard security",
            "description": "Protection of user API keys"
          }
        ]
      },
      {
        ...
        "features": [
          ...
          },
          {
            ...
            "olly": true,
            "competitor": false,
            "description": "Clear information about API usage costs"
          }
        ]
      }
    ]
  ...
  "1stroke-ai": {
    "name": "1Stroke",
    "shortDescription": "Chrome extension for AI-powered replies across the web",
    "category": "AI Communication Assistant",
    "comparisonImage": "/images/comparisons/onestroke.png",
    "features": [
      {
        "category": "AI Capabilities",
        "features": [
          ...
          {
            "name": "Content Generation",
            "olly": "Multi-platform optimized content",
            "competitor": "Context-aware replies",
        ...
        "features": [
          {
            "name": "Supported Platforms",
            "olly": ["LinkedIn", "Twitter/X", "Facebook", "Instagram", "Reddit", "Product Hunt", "YouTube", "Quora", "Medium", "TikTok", "Threads", "HackerNews"],
            "competitor": ["X (Twitter)", "Outlook", "Meta", "Gmail", "LinkedIn", "Review platforms", "WhatsApp Web"],
            "description": "Platforms where the tool can be used"
          },
          {
            "name": "Integration Method",
            "olly": "Browser extension",
            "competitor": "Chrome extension only",
            "description": "How the tool integrates with platforms"
          },
          {
            "name": "Usage Method",
            "olly": "Direct interaction on platform",
            "competitor": "Right-click context menu",
            "description": "How users interact with the tool"
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "olly": ["Social media engagement", "Content creation", "Cross-platform management"],
            "competitor": ["Content creation", "Email", "E-commerce", "Online Reviews", "Human Resources", "Educational Platforms"],
            "description": "Main applications of the tool"
          },
          {
            "name": "Professional Focus",
            "olly": ["Social media managers", "Content creators", "Marketing teams"],
            "competitor": ["Content Creators", "Community Managers", "Sales", "Customer Service", "Entrepreneurs"],
            "description": "Professional roles targeted"
          }
        ]
      },
      {
        ...
        "features": [
          ...
          },
          {
            ...
            "olly": true,
            "competitor": false,
            "description": "Unified experience across platforms"
          }
        ]
      },
      {
        ...
        "features": [
          ...
          },
          {
            ...
            "olly": false,
            "competitor": true,
            "description": "Need to create account and log in to use"
          }
        ]
      },
      {
        ...
        "features": [
          {
            "name": "Free Tier",
            "olly": "5 comments/day forever",
            "competitor": "7-day trial with 20 credits/day",
            "description": "Free offering"
          },
          {
            "name": "Starting Price",
            "olly": "$9.99/month",
            "competitor": "$7.50/month",
            "description": "Base subscription cost"
          },
          {
            "name": "Premium Features",
            "olly": "All features included in base price",
            "competitor": "2,000 credits/month",
            "description": "What's included in paid plan"
          },
          {
            "name": "Lifetime Option",
            "olly": "$49.99",
  ...
  "redcom": {
    name: "RedCom AI",
    shortDescription: "Reddit and Quora focused engagement platform",
    category: "Platform-Specific Engagement",
    comparisonImage: "/images/comparisons/redcom.png",
    features: [
      {
        ...
        features: [
          {
            name: "Supported Platforms",
            olly: ["LinkedIn", "Twitter/X", "Facebook", "Instagram", "Reddit", "Product Hunt", "YouTube", "Quora", "Medium", "TikTok", "Threads", "HackerNews"],
            competitor: ["Reddit", "Quora"],
            description: "Social media platforms supported"
          },
          {
            name: "Platform Integration",
            olly: "Direct browser extension",
            competitor: "Web dashboard",
            description: "Method of integration with platforms"
          }
        ]
      },
      {
        ...
        features: [
          ...
          },
          {
            ...
            olly: true,
            competitor: false,
            description: "Customizable AI voices"
          },
          {
            name: "Comment Generation",
            olly: true,
            competitor: true,
            description: "AI-powered comment creation"
          }
        ]
      },
      {
        ...
        features: [
          ...
          },
          {
            ...
            olly: false,
            competitor: "Weekly",
            description: "Regular update emails"
          }
        ]
      },
      {
        ...
        features: [
          {
            name: "Multi-brand Support",
            olly: true,
            competitor: "3-8 brands (paid plans)",
            description: "Multiple brand management"
          },
          {
            name: "Performance Tracking",
        ...
        features: [
          {
            name: "Free Tier",
            olly: "5 comments/day",
            competitor: "1 keyword, 20 comments/month",
            description: "Free plan offering"
          },
          {
            name: "Starting Price",
            olly: "$9.99/month",
            competitor: "$19.95/month",
            description: "Base subscription cost"
          },
          {
            name: "Lifetime Option",
  ...
  "stampede": {
    name: "Stampede Social",
    shortDescription: "Instagram and Facebook focused revenue generation platform",
    category: "Social Media Monetization",
    comparisonImage: "/images/comparisons/stampede.png",
    features: [
      {
        category: "Platform Focus",
        features: [
          {
            ...
            description: "Social platforms supported"
          },
          {
            name: "Meta Approval",
            olly: false,
            competitor: true,
            description: "Officially approved by Meta"
          }
        ]
      },
      {
        ...
        features: [
          ...
          },
          {
            ...
            olly: false,
            competitor: true,
            description: "Contest and giveaway tools"
          },
          {
            name: "QR Code Integration",
            olly: false,
            competitor: true,
            description: "Custom QR codes for engagement"
          }
        ]
      },
      {
        ...
        features: [
          ...
          },
          {
            ...
            olly: false,
            competitor: true,
            description: "Engagement database of followers"
          },
          {
            name: "Post Management",
            olly: false,
      ...
      },
      {
        ...
        features: [
          {
            name: "Revenue Focus",
            olly: "General engagement",
            competitor: "Direct monetization",
            description: "Primary business goal"
          },
          {
            name: "Fan-Generated Content",
            olly: false,
            competitor: true,
            description: "User content management"
          },
          {
            name: "Live Event Features",
            olly: false,
            competitor: true,
            description: "Tools for live streaming"
          }
        ]
      },
      {
        ...
        features: [
          {
            name: "Free Trial",
            olly: "5 comments/day forever",
            competitor: "7-day free trial",
            description: "Free offering"
          },
          {
            name: "Plan Structure",
            olly: "Simple pricing",
            competitor: "Tiered (Creator, Pro, Pro Plus)",
  ...
  "comment-generator-dot-com": {
    name: "Comment Generator",
    shortDescription: "Platform-specific comment generation browser extension",
    category: "Comment Generation Tool",
    comparisonImage: "/images/comparisons/commentgenerator.png",
    features: [
      {
        category: "Platform Support",
        features: [
          ...
          },
          {
            ...
            olly: "Browser extension",
            competitor: "Chrome extension only",
            description: "Platform integration approach"
          }
        ]
      },
      {
        ...
        features: [
          {
            ...
            olly: ["OpenAI", "Claude", "Gemini", "Local Models", "Straico", "OpenRouter"],
            competitor: ["Unspecified AI model"],
            description: "AI language models used"
          },
          {
            name: "Comment Styles",
            olly: "Customizable personalities",
            competitor: ["Genuinely agree", "Politely disagree", "Act surprised", "Be funny"],
            description: "Available commenting styles"
          },
          {
            name: "Custom AI Personalities",
            olly: true,
            competitor: false,
            description: "Create and customize AI voices"
          }
        ]
      },
      {
        ...
        features: [
          {
            ...
            olly: "No account connection needed",
            competitor: "No account connection needed",
            description: "Platform login requirements"
          },
          {
            name: "Ease of Use",
            olly: "Click to generate",
            competitor: "Click to generate",
            description: "Simplicity of interface"
          },
          {
            name: "Language Support",
            olly: "Multiple languages",
