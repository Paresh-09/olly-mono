...
// Updated request body schema - LinkedIn uses existing fields, others use platformSettings
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Default platform settings - LinkedIn uses existing fields, others use JSON
