...
const models = [
  { name: "claude-sonnet-4-0", inputPrice: 3.0, outputPrice: 15.0 },
  { name: "claude-opus-4-1-20250805", inputPrice: 15.0, outputPrice: 75.0 },
  { name: "claude-3-7-sonnet-latest", inputPrice: 3.0, outputPrice: 15.0 },
  { name: "claude-opus-4-0", inputPrice: 15.0, outputPrice: 75.0 },
  { name: "claude-3-5-haiku-latest", inputPrice: 0.25, outputPrice: 1.25 },
  { name: "claude-3-opus-latest", inputPrice: 15.0, outputPrice: 75.0 },
  { name: "claude-3-5-sonnet-latest", inputPrice: 3.0, outputPrice: 15.0 },
];

const commentLengthOptions = [150, 250, 500];

const ClaudeCostCalculator: React.FC = () => {
  const [selectedModel, setSelectedModel] = useState(models.find((model) => model.name === "claude-sonnet-4-0") || models[0]);
...
export default ClaudeCostCalculator;